...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help xD.
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                buttons = InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/Wolverinexmen_bot?startgroup=botstart")],
                    [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/Sammy0007_chat")],
                    [InlineKeyboardButton(text="❓ Help", url="t.me/Wolverinexmen_bot?start=help")]]),
                update.effective_message.reply_text(
        ...
        update.effective_message.reply_text("Running, Faster then Bolt!")
